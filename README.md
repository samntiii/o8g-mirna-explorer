...
|---|---|---|
| **Single state — targets** | One oxidation state; BE ranking; optional energetics | `utr3_human.parquet`, ViennaRNA |
| **Compare two states** | Lost / gained / shared + pathway volcano with within-pool control | `genesets/` |
...
| **Transcription factors** | TF genes among gained/lost/retained | TF GMTs under `genesets/` |
| **Loss of function** | miRDB-anchored attrition (`gained ≡ 0` is structural) | `mirdb_ref.parquet` |
| **Statistics** | ORA (± optional GSEA); UTR-universe + within-pool backgrounds | `genesets/`, `gseapy` |
...
**Precision modes** (sidebar): **Sensitive** / **Stringent** / **Consensus**.
